...
MCP_SERVERS: dict[str, MCPServerDef] = {
    "news_geopolitical": MCPServerDef(
        ...
        description="News & Geopolitical Intelligence — GDELT events, disaster alerts, news search, Wikipedia knowledge",
        tools=[
            "news_search",
            "gdelt_events",
            "gdelt_tone",
    ...
    "shipping_logistics": MCPServerDef(
        ...
        health_check_tool="weather_forecast",
    ),
    ...
    "finance_market": MCPServerDef(
        ...
        rate_limit_per_minute=30,
        health_check_tool="exchange_rate",
    ),
    "web_intel": MCPServerDef(
        name="web_intel",
        description="Web Intelligence — Firecrawl scrape/crawl/search/extract, Reddit, social sentiment, competitor intel",
        tools=[
            "web_scrape",
            "web_crawl",
            "web_search",
...
AGENT_SERVER_MAP: dict[str, list[str]] = {
    ...
    "supply":     ["erp_inventory", "shipping_logistics", "route_optimization", "web_intel", "rag"],
    "logistics":  ["shipping_logistics", "climate_risk", "route_optimization", "web_intel", "rag"],
    ...
    "finance":    ["finance_market", "commodity_prices", "market_radar", "erp_inventory",
                   "enhanced_finance", "forex_backup", "web_intel", "rag"],
